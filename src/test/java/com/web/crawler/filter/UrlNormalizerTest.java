...
public class UrlNormalizerTest {
	...
	public void testNormalize() {
		...
		// urls with ../ in.
		normalizedUrl = UrlNormalizer.normalize("../java/interfaces.html",
				"http://tutorials.jenkov.com/html4/index.html");
		assertEquals("http://tutorials.jenkov.com/java/interfaces.html", normalizedUrl);

		normalizedUrl = UrlNormalizer.normalize("../../../java/interfaces.html",
				"http://tutorials.jenkov.com/html4/level1/level2/index.html");
		assertEquals("http://tutorials.jenkov.com/java/interfaces.html", normalizedUrl);

		normalizedUrl = UrlNormalizer.normalize("/flex-tetris/more/../../index.html",
				"http://tutorials.jenkov.com/html4/level1/level2/index.html");
